...
/**
 * Developer's fee: 10% of the profit generated by orders placed on or after
 * DEV_FEE_START. This is an admin↔developer accounting item — it is never
 * charged to customers and does not appear on any invoice or order total. It
 * only reduces reported net profit.
 */
const DEV_FEE_RATE = 0.1;
const DEV_FEE_START = "2026-06-10";
const DEV_FEE_START_LABEL = "10 Jun, 2026";
...
export function ReportsView({
  ...
  // Developer's fee — 10% of the profit generated by orders placed on/after the
  ...
  const devFeeBase = validOrders.reduce((sum, o) => {
    ...
    return sum + (Number(o.subtotal) - itemsCost + Number(o.admin_delivery_earning));
  }, 0);
  const devFee = devFeeBase * DEV_FEE_RATE;
            ...
            <div className="grid grid-cols-2 gap-4 lg:col-span-2">
              ...
              <AdminCard title="Developer Fees">
                ...
                <div className="mt-1 space-y-0.5 text-xs text-gray-500">
                  ...
                  <p>· {DEV_FEE_START_LABEL} onwards</p>
                </div>
              </AdminCard>
            </div>
          </div>
